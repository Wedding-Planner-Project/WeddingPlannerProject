...
const getRandomCouple = () => couples[Math.floor(Math.random() * couples.length)];


function ViewPage() {
    return (
      <div className="mb-1 mx-1 card" style={{ zoom: "70%", borderRadius: "15px", overflow: "hidden" }}>
  <Carousel className="card-body" style={{ borderRadius: "15px", overflow: "hidden" }}>
                        ...
                        {Array.from({ length: 3 }).map((_, index) => {
                            ...
                            return (
                              ...
                              <div className="card-sl">
                                  ...
                                  <Link to="/reviews" className="card-button">Read More</Link>
                              </div>
                          </div>
                            );
                        })}
