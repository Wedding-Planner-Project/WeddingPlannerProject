...
function CustomerOrders() {
  ...
  useEffect(() => {
    const url =
      createUrl("/customer/p/orders/") + sessionStorage.getItem("email");
    // const url =
  ...
  const updateOrder = (args) => {
    debugger;
    const url = createUrl("/customer/p/orders/") + args.target.value;
    // const url =
  ...
  const cancelOrder = (args) => {
    const url = createUrl("/customer/p/order/") + args.target.value;
    // const url =
